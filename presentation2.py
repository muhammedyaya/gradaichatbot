...
def add_formatted_paragraph(text_frame, text, font_name, font_size, alignment, color_rgb):
    """
    Add a paragraph with bold support using **bold** markdown.
    """
...
def create_presentation(
    ...
    if not re.match(r'^#(?:[0-9a-fA-F]{3}){1,2}$', theme_color):
        raise ValueError("Invalid theme color format")
    ...
    try:
        ...
        theme_rgb = RGBColor.from_string(theme_color.lstrip("#"))
        ...
        # ✅ Delete the first 2 empty slides if they exist
